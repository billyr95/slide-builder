...
export function trainEntryToRow(entry: Partial<TrainEntry>, userId: string): NewRow {
  ...
  return {
    ...
    titleColor: entry.titleColor ?? null,
    subtitleColor: entry.subtitleColor ?? null,
    subtitle2Color: entry.subtitle2Color ?? null,
    presentersColor: entry.presentersColor ?? null,
    programTitleColor: entry.programTitleColor ?? null,
    seriesNameColor: entry.seriesNameColor ?? null,
    listeningCreditColor: entry.listeningCreditColor ?? null,
...
export function rowToTrainEntry(row: Row): TrainEntry {
  return {
    ...
    subtitleColor: row.subtitleColor ?? undefined,
    subtitle2Color: row.subtitle2Color ?? undefined,
    presentersColor: row.presentersColor ?? undefined,
    programTitleColor: row.programTitleColor ?? undefined,
    seriesNameColor: row.seriesNameColor ?? undefined,
    listeningCreditColor: row.listeningCreditColor ?? undefined,
